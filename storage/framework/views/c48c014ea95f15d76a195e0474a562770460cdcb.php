            ...
            <div class="row">
                ...
                <div class="col-sm-6 col-md-5">
                    ...
                    <div class="slick-slider carousel-parent" data-arrows="false" data-loop="false" data-dots="false" data-swipe="true" data-items="1" data-child="#child-carousel" data-for="#child-carousel" data-photo-swipe-gallery="gallery">
                        ...
                        <div class="item">
                            <a class="img-thumbnail-variant-2"
                               href="<?php echo e(temp_xml_img('https://b2b-sandi.com.ua/imagecache/large/' . strval($product->sku)[0] . '/' . strval($product->sku)[1] . '/' .  $product->sku . '.jpg')); ?>"
                               data-photo-swipe-item=""
                               data-size="2000x2000">

                                <figure>
                                    <img src="<?php echo e(temp_xml_img('https://b2b-sandi.com.ua/imagecache/large/' . strval($product->sku)[0] . '/' . strval($product->sku)[1] . '/' .  $product->sku . '.jpg')); ?>" alt="" width="535" height="535"/>
                                </figure>

                                <div class="caption"><span class="icon icon-lg linear-icon-magnifier"></span></div></a>
                        </div>

                        <?php $__currentLoopData = temp_additional($product->sku); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $uri): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="item">
                                <a class="img-thumbnail-variant-2"
                                   ...
                                   data-size="2000x2000">
                                    <figure>
                                        <img src="<?php echo e($uri); ?>" alt="" width="535" height="535"/>
                                    </figure>
                                    <div class="caption"><span class="icon icon-lg linear-icon-magnifier"></span></div></a>
                            </div>
                    ...
                    <div class="slick-slider" id="child-carousel" data-for=".carousel-parent" data-arrows="false" data-loop="false" data-dots="false" data-swipe="true" data-items="3" data-xs-items="4" data-sm-items="4" data-md-items="4" data-lg-items="5" data-slide-to-scroll="1">
                        ...
                        <div class="item">
                            <img src="<?php echo e(temp_xml_img('https://b2b-sandi.com.ua/imagecache/large/' . strval($product->sku)[0] . '/' . strval($product->sku)[1] . '/' .  $product->sku . '.jpg')); ?>" alt="" width="89" height="89"/>
                        </div>
                        ...
                        <?php $__currentLoopData = temp_additional($product->sku); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $uri): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="item">
                                ...
                                <img src="<?php echo e($uri); ?>" alt="" width="89" height="89"/>
                ...
                <div class="col-sm-6 col-md-7">
                    <div class="product-single">
                        ...
                        <br>
                        <p class="product-code" style="font-style: italic;"><span>Код товара:</span> <?php echo e($product->details['sku']); ?></p>
                        ...
                        <ul class="product-meta mt-5">
                            <li>
                                <dl class="list-terms-minimal">
                                    <dt>SKU</dt>
                                    <dd><?php echo e($product->details['sku']); ?></dd>
                                </dl>
                            </li>
                            <li>
                                <dl class="list-terms-minimal">
