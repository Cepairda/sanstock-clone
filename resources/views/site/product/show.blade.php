            ...
            <div class="row">
                ...
                <div class="col-sm-6 col-md-5">
                    ...
                    <div class="slick-slider" id="child-carousel" data-for=".carousel-parent" data-arrows="false"
                         data-loop="false" data-dots="false" data-swipe="true" data-items="3" data-xs-items="4"
                         data-sm-items="4" data-md-items="4" data-lg-items="5" data-slide-to-scroll="1">
                        <div class="item"><img src="{{ asset('images/site/21689.jpg') }}" alt="" width="89"
                                               height="89"/>
                        </div>
                        <div class="item"><img src="{{ asset('images/site/21689_1.jpg') }}" alt="" width="89"
                                               height="89"/>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-sm-6 col-md-7">
                    <div class="product-single">
                        ...
                        <p class="product-text">Смесителя Lidz изготовлены из нержавеющей стали. Благодаря
                            никелированной брашированной поверхности имеют оригинальный внешний вид. Выполнены в
                            современном сдержанном стиле. Такие смесителф не только удобны и практичны, но и идеально
                            дополнит интерьер.</p>
                    ...
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab"
                               aria-controls="profile" aria-selected="false">Технические характеристики</a>
                        </li>
                    </ul>
