...
/***/ "./resources/js/site/plugins/jquery.filer.js":
/*!***************************************************!*\
  !*** ./resources/js/site/plugins/jquery.filer.js ***!
  \***************************************************/
/*! no static exports found */
    ...
    return this.each(function (t, r) {
      var s = $(r),
        ...
        _clear: function _clear() {
          ...
          f._set('feedback', f._itFl && f._itFl.length > 0 ? f._itFl.length + ' ' + n.captions[n.options.language].feedback2 : n.captions[n.options.language].feedback);
        ...
        _filesCheck: function _filesCheck() {
          ...
          if (n.limit && f.files.length + f._itFl.length > n.limit) {
            n.dialogs.alert(f._assets.textParse(n.captions[n.options.language].errors.filesLimit));
            return false;
          }
          ...
          for (var t = 0; t < f.files.length; t++) {
            ...
            if (n.extensions != null && $.inArray(x, n.extensions) == -1 && $.inArray(m.type, n.extensions) == -1) {
              n.dialogs.alert(f._assets.textParse(n.captions[n.options.language].errors.filesType, m));
              return false;
            }

            if (n.maxSize != null && f.files[t].size > n.maxSize * 1048576 || n.fileMaxSize != null && f.files[t].size > n.fileMaxSize * 1048576) {
              n.dialogs.alert(f._assets.textParse(n.captions[n.options.language].errors.filesSize, m));
              return false;
            }

            if (file.size == 4096 && file.type.length == 0) {
              n.dialogs.alert(f._assets.textParse(n.captions[n.options.language].errors.folderUpload, m));
              return false;
            }
          ...
          if (n.maxSize != null && s >= Math.round(n.maxSize * 1048576)) {
            n.dialogs.alert(f._assets.textParse(n.captions[n.options.language].errors.filesSizeAll));
            return false;
          }
            ...
            if (l.length < 1) {
              ...
              l.on('click', n.templates._selectors.remove, function (e) {
                ...
                if (n.templates.removeConfirmation) {
                  n.dialogs.confirm(n.captions[n.options.language].removeConfirmation, c);
                } else {
                  c();
                }
              });
        ...
        _dragDrop: {
          dragEnter: function dragEnter(e) {
            ...
            f._set('feedback', n.captions[n.options.language].drop);
          ...
          dragLeave: function dragLeave(e) {
            ...
            f._dragDrop._drt = setTimeout(function (e) {
              ...
              f._set('feedback', n.captions[n.options.language].feedback);
        ...
        _onChange: function _onChange(e, d) {
          ...
          f._set('feedback', f.files.length + f._itFl.length + ' ' + n.captions[n.options.language].feedback2);
        ...
        _remove: function _remove(e, el) {
          ...
          var excl_input = function excl_input(val) {
            ...
            if (f._itFl.length < 1) {
              ...
              f._set('feedback', f._itFl.length + ' ' + n.captions[n.options.language].feedback2);
            }
...
/***/ 3:
/*!*********************************************************!*\
  !*** multi ./resources/js/site/plugins/jquery.filer.js ***!
  \*********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\Project\OpenServer\domains\lidz.ua.local\resources\js\site\plugins\jquery.filer.js */"./resources/js/site/plugins/jquery.filer.js");
