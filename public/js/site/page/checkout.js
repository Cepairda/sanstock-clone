...
/***/ "./resources/js/site/page/checkout.js":
/*!********************************************!*\
  !*** ./resources/js/site/page/checkout.js ***!
  \********************************************/
/*! no static exports found */
...
(function () {
  ...
  $(document).ready(function () {
    ...
    var Select2Cascade = function Select2Cascade(parent, child, url, select2Options) {
    ...
    var Select2CustomMatcher = function Select2CustomMatcher(params, data) {
      ...
      var alt = removeDiacritics(data.alt || data.element.dataset.alt || "").toUpperCase(),
          original = removeDiacritics(data.text).toUpperCase(),
          term = removeDiacritics(params.term).toUpperCase(); // Check if the text contains the term
    ...
    $("div.container-delivery-form").each(function (index, container) {
      var delivery = 'new_mail',
          //container.dataset.delivery,
      delivery_service = 'new_mail',
          //container.dataset.delivery,
      select2Options = _objectSpread(_objectSpread({}, defaultSelect2Options), {}, {
        width: '100%',
      ...
      new Select2Cascade($region, $city, function () {
...
/***/ 1:
/*!**************************************************!*\
  !*** multi ./resources/js/site/page/checkout.js ***!
  \**************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\OpenServer\domains\sandistock.local\resources\js\site\page\checkout.js */"./resources/js/site/page/checkout.js");
